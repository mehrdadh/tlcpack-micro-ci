...
import microDevice_pb2 as microDevice__pb2
...
class RPCRequestStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RPCDeviceRequest = channel.unary_unary(
                ...
                request_serializer=microDevice__pb2.DeviceMessage.SerializeToString,
                response_deserializer=microDevice__pb2.DeviceReply.FromString,
                )
        ...
        self.RPCSessionRequest = channel.unary_unary(
                ...
                request_serializer=microDevice__pb2.SessionMessage.SerializeToString,
                response_deserializer=microDevice__pb2.SessionMessage.FromString,
                )
        ...
        self.RPCDeviceRequestList = channel.unary_unary(
                ...
                request_serializer=microDevice__pb2.StringMessage.SerializeToString,
                response_deserializer=microDevice__pb2.StringMessage.FromString,
                )
...
def add_RPCRequestServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RPCDeviceRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=microDevice__pb2.DeviceMessage.FromString,
                    response_serializer=microDevice__pb2.DeviceReply.SerializeToString,
            ),
            ...
            'RPCSessionRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=microDevice__pb2.SessionMessage.FromString,
                    response_serializer=microDevice__pb2.SessionMessage.SerializeToString,
            ),
            ...
            'RPCDeviceRequestList': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=microDevice__pb2.StringMessage.FromString,
                    response_serializer=microDevice__pb2.StringMessage.SerializeToString,
            ),
...
class RPCRequest(object):
    ...
    def RPCDeviceRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/microDevice.RPCRequest/RPCDeviceRequest',
            microDevice__pb2.DeviceMessage.SerializeToString,
            microDevice__pb2.DeviceReply.FromString,
    ...
    def RPCSessionRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/microDevice.RPCRequest/RPCSessionRequest',
            microDevice__pb2.SessionMessage.SerializeToString,
            microDevice__pb2.SessionMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RPCDeviceRequestList(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/microDevice.RPCRequest/RPCDeviceRequestList',
            microDevice__pb2.StringMessage.SerializeToString,
            microDevice__pb2.StringMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

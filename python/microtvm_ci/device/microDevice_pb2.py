...
# source: python/microtvm_ci/device/microDevice.proto
...
DeviceMessage = _reflection.GeneratedProtocolMessageType('DeviceMessage', (_message.Message,), {
  ...
  '__module__' : 'python.microtvm_ci.device.microDevice_pb2'

...
def parse_args() -> argparse.Namespace:
    ...
    device_arg = "--device", type=str, required=True, choices=device_utils.MICRO_DEVICE_TYPES, help="MicroTVM device to request."
    ...
    parser_attach.add_argument(device_arg)
    parser_attach.add_argument(vm_path_arg)
    parser_attach.add_argument(
        "--wait", action="store_true", help="Wait if device not available."
    )
    parser_attach.add_argument(artifact_path_arg)
    ...
    parser_detach.add_argument(device_arg)
    parser_detach.add_argument(vm_path_arg)
    parser_detach.add_argument(artifact_path_arg)
    parser_detach.add_argument(serial_arg)
    ...
    parser_release.add_argument(device_arg)
    parser_release.add_argument(serial_arg)
    ...
    parser_query.add_argument(serial_arg)

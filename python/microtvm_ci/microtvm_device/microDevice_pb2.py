...
# source: microtvm_ci/microtvm_device/microDevice.proto
...
DeviceMessage = _reflection.GeneratedProtocolMessageType('DeviceMessage', (_message.Message,), {
  ...
  '__module__' : 'microtvm_ci.microtvm_device.microDevice_pb2'
